...
class FormUpdateSetPage extends StatefulWidget {
  final TennisSet setTennis;
  final Game game;

  FormUpdateSetPage({Key key, this.setTennis, this.game}) : super(key: key);

  @override
  _FormUpdateSetPageState createState() => _FormUpdateSetPageState();
}

class _FormUpdateSetPageState extends State<FormUpdateSetPage> {
